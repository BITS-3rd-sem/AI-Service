...
public class AIServiceImpl implements AIService {
    ...
    @Override
    public ResponseDTO getSpecializationRecomendation(PromptDTO promptDTO) throws JsonProcessingException {
        ...
        prompt = MessageFormat.format(prompt, String.join(",", promptDTO.getSpecializations()), promptDTO.getSymptom());
